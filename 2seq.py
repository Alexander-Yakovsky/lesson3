...
number = input('Введите цифры через запятую: ')
zapret = "/"

while True:
    if zapret in number:
        print("Неправильный ввод. Нужно через запятую!")
        number = input('Введите цифры через запятую: ')
    else:
        break

list_number = number.split(',')         #убрали запятые и создали новый список
print(list_number)
print(set(list_number))                 #отделили не повторяющиеся числа и вывели их